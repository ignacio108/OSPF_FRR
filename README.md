...
The main objective of this virtual laboratory will be to implement the RFC6518.
To avoid OSPF routers to establish a neighbourhood with malicious routers.
